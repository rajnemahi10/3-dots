from modular_gui.engine import get_active_joker_positions
...
def draw_jokers(canvas, cell_size, origin_x=0, origin_y=0):
    radius = max(12, cell_size // 4)

    for row, col in get_active_joker_positions():
...
def draw_game(canvas, board, selected, legal_moves, cell_size, origin_x=0, origin_y=0):
    ...
    draw_jokers(canvas, cell_size, origin_x, origin_y)
